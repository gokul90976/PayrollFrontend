...
@Component({
  selector: 'app-supplementary-salary',
  templateUrl: './supplementary-salary.component.html',
  styleUrl: './supplementary-salary.component.css'
})
export class SupplementarySalaryComponent {
  ...
  submit: boolean
  approve: boolean
  selectedOption: string = 'Supplementary Salary'; // Initially no option is selected
  empList: any
  totalDeduction: any;
  financialDate: Date;
  ...
  getEmpList(): void {
    this.apiCall.getSalariesVary("EmployeeDataBasedOn-paymentStatus",'No').subscribe(data => {
