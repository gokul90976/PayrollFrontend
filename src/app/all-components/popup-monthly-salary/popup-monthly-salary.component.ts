...
@Component({
  selector: 'app-popup-monthly-salary',
  templateUrl: './popup-monthly-salary.component.html',
  styleUrl: './popup-monthly-salary.component.css'
})
export class PopupMonthlySalaryComponent {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<PopupMonthlySalaryComponent>, private fb: FormBuilder,
    private httpservice: HttpService, private activeRoute: ActivatedRoute, private apiCall: ApiService, private snackbar: MatSnackBar, private elementRef: ElementRef,private datePipe: DatePipe) {
      this.getPercentages()
